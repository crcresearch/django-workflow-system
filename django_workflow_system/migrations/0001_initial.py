    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Human friendly name", max_length=200),
                ),
                (
                    "version",
                    models.PositiveIntegerField(
                        default=1,
                        help_text="The version of a Workflow. Used to accommodate the evolution of a Workflow over time",
                    ),
                ),
                (
                    "on_completion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category",
                    models.CharField(
                        choices=[("SURVEY", "survey"), ("ACTIVITY", "activity")],
                        default=None,
                        max_length=8,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(help_text="The description of the data group."),
                ),
                (
                    "parent_group",
                    models.ForeignKey(
                        ...
                        to="django_workflow_system.workflowmetadata",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The name of the question type.", max_length=150
                    ),
                ),
                (
                    "json_schema",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="django_workflow_system.workflowstep",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                to="django_workflow_system.workflowstepuitemplate",
            ),
        ),
        migrations.AddField(
            model_name="workflowstep",
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.CASCADE,
                to="django_workflow_system.workflow",
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        max_length=200, null=True, upload_to=author_media_location
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                to="django_workflow_system.workflowauthor",
            ),
        ),
        migrations.AddField(
            model_name="workflow",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="django_workflow_system.workflowstepuserinputtype",
                    ),
                ),
                (
                    "workflow_step",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.ImageField(
                        max_length=200, upload_to=workflow_step_media_location
                    ),
                ),
                (
                    "workflow_step",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="django_workflow_system.workflowstepdependencygroup",
                    ),
                ),
                (
                    "dependency_step",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        max_length=200, upload_to=workflow_image_location
                    ),
                ),
                (
                    "type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="django_workflow_system.workflowcollectionsubscription",
                    ),
                ),
            ],
            options={
                ...
                "unique_together": {
                    ("workflow_collection_subscription", "day_of_week")
                },
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        max_length=200, upload_to=collection_image_location
                    ),
                ),
                (
                    "collection",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(
                    ("status", "ASSIGNED"), ("status", "IN_PROGRESS"), _connector="OR"
                ),
